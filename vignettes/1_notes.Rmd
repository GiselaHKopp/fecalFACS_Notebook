...
* Everything ordered, but not everyting delivered yet
* Main topic is how to proceed with laboratory work in light of Kunze's safety concerns  
	+ Response from Flow Cytometry at ETH Zürich: request more information. Melina filled out document and will send it to Gisela for verification.   
	+ Gisela will discuss sample safety issue Inge and Daniel, get barbary macaque health information from Roland.     
	+ If flow cytometry will be done externally: problem, that prepared samples can only be stored overnight. Melina might be able to spend some days in Freiburg and do everything there. 
